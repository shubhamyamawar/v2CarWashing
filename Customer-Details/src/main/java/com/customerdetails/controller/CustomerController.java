...
import com.customerdetails.models.ListCustomer;
...
//	public ResponseEntity<ListCustomer> getAllCustomer() {
//		logger.trace("Get all customer is running");
//         ListCustomer list=new ListCustomer();
//         list.setList(customerRepository.findAll());
//         return new ResponseEntity<>(list, HttpStatus.OK);
//	}
	@GetMapping("/get-all-customer")
	public ResponseEntity<ListCustomer> getAllCustomer() {
		ListCustomer list=customerServiceImpl.getListCustomer();
         return new ResponseEntity<>(list, HttpStatus.OK);
	}
